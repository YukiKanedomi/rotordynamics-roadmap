...
export const CASES: CaseStudy[] = [
  {
    ...
    read: 'B3 の壁は物理的に越えられる（実証済み）。ただし成立条件（節配置・バランス精度）が量産条件と相性が悪い——「実験室では四半世紀前に実証、産業は今も原則回避」の起点。',
    ratio: 2.49,
  ...
  },
  {
    ...
    read: '産業の標準解＝亜臨界設計の生きた実例。分離余裕の引用元が ANSI/HI 9.6.8（ポンプ規格）である点は、ガス軸受機の規格ギャップ（D5-8）の傍証。',
    ratio: 0.72,
  ...
  },
  {
    ...
    nums: [
      { label: '条件', value: '715°C／250 bar／27,000 rpm' },
  ...
  },
  {
    ...
    read: 'B7（AMB側）の量産スケール実装。ISO 14839-5（タッチダウン軸受）が効く領域の代表例。',
