...
export const SOURCES: SourceRef[] = [
  ...
  { key: 'GreenGasTurbines-OEM-2026', title: 'Hydrogen-Ready Gas Turbines OEM Comparison 2026', url: 'https://www.greengasturbines.com/blog/hydrogen-ready-gas-turbines-oem-comparison', primary: false },
  ...
  { key: 'GE-NASA-Hybrid-2022', title: 'NASA/GE — MW-class hybrid-electric engine 45,000ft test', url: 'https://www.flyingmag.com/nasa-ge-test-hybrid-electric-engine/', primary: false },
  ...
  { key: 'Cleanview-BTM-2025', title: 'Cleanview — Behind-the-Meter Data Centers (82GW)', url: 'https://cleanview.co/reports/behind-the-meter-data-centers', primary: false },
  ...
  { key: 'Joby-Stage4-2026', title: 'Joby — FAA型式証明Stage 4完了（2026-03）・TC 2026後半見込み', url: 'https://www.commercialuavnews.com/faa-regulation-certification-aam-joby-archer-electra', primary: false },
  ...
  { key: 'NASA-TMX71877-1976', title: 'Bamberger/Zaretsky/Signer — Main-shaft jet engine bearings at 3×10⁶ DN (NASA TM X-71877, 1976)', url: 'https://ntrs.nasa.gov/citations/19760011411', primary: true },
  ...
  { key: 'Nicholas-Kocur-2005', title: 'Nicholas & Kocur — Rotordynamic Design per New API Stability Specs（modified Alford式, 34th TPS 2005）', url: 'https://dyrobes.com/wp-content/uploads/2015/09/Rotordynamic-Design-of-Centrifugal-Compressors-in-Accordance-with-the-New-API-Stability-Specifications_linked.pdf', primary: true },
  { key: 'Schweitzer-AMB-Load', title: 'Schweitzer 系 — AMB実用比荷重 20–40 N/cm²（IntechOpen 引用経由・教科書本文未達）', url: 'https://www.intechopen.com/chapters/41670', primary: false },
  { key: 'SiemensEnergy-H2Pipeline-2021', title: 'Siemens Energy — 100%水素パイプライン圧縮（Ti合金6段・PR4:1, 2021）', url: 'https://turbomag.mjhassoc.com/readying-pipeline-compressor-stations-for-100-hydrogen/', primary: true },
...
export const SOURCE_META: Record<string, { cat: SourceCat; note?: string }> = {
  ...
  'Dinglun-Flywheel-2024': { cat: 'tech', note: '磁気浮上フライホイール120基・30MW系統接続（世界最大）。業界メディア複数の二次整合＝中国側一次は未到達。' },
  ...
  'Nicholas-Kocur-2005': { cat: 'research', note: 'API Level I の modified Alford 式（Q=c·63000·hp/(Hc·Dc·N)·ratio, c=3.0）。B4 比例形の根拠。' },
  'Schweitzer-AMB-Load': { cat: 'research', note: 'AMB実用比荷重 約20–40 N/cm²（基準=投影面積）の Schweitzer 系明文。二次引用経由（Schweitzer & Maslen 2009 本文は未達）。' },
  'SiemensEnergy-H2Pipeline-2021': { cat: 'tech', note: '高強度Ti合金で pure H2 6段・圧力比4:1 が可能＝B6 材料律速の緩和策の実例。' },
